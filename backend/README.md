...
## Project Structure
    ...
    ├── testapiautostorybo_128795  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_128795`
...
2. Clone this repo and `cd testapiautostorybo_128795`
